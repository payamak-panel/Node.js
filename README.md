# payamak-panel Node.js

## Introduction
Here we've provided a complete 3rd-party library (SDK) for Nodejs developers that covers both **SOAP** and **REST** webservices. Before using, make sure you have provided a [valid account in PARS corporation](https://pars.ws/).
